...
class TiendanubeConnectionService:
    ...
    def initiate_auth(self, req: AuthInitiateRequest, state: str) -> str:
        """Generate the authorization URL for Tiendanube OAuth flow.

        Args:
            req: Auth initiation request with client_id and store_id.
            state: CSRF state token generated by the caller.
        ...
        return (
            f"{TIENDANUBE_AUTH_URL.format(client_id=req.client_id)}"
            f"?store_id={req.store_id}"
