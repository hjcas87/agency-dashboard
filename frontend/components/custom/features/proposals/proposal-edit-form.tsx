...
import { updateProposalAction, getClientsForSelect, type ProposalTask } from '@/app/actions/custom/proposals'
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input id="exchangeRate" type="number" step="0.01" min="0" value={exchangeRate} onChange={e => setExchangeRate(e.target.value)} />
        </div>
        <div className="flex flex-col gap-2">
          <Label htmlFor="adjustment">
            Ajuste ({parseFloat(adjustmentPct) < 0 ? 'Descuento' : parseFloat(adjustmentPct) > 0 ? 'Recargo' : 'Sin ajuste'})
          </Label>
